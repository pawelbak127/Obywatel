...
const TABLES: Array<{ label: string; table: string; note: string }> = [
  ...
  { label: 'Kluby', table: 'clubs', note: 'kluby i kola poselskie' },
  { label: 'Głosowania', table: 'votings', note: 'glosowania imienne z protokolow' },
  { label: 'Głosy imienne', table: 'votes', note: 'po jednym na posla i glosowanie' },
  { label: 'Procesy legislacyjne', table: 'legislative_processes', note: 'sciezka kazdego druku' },
  { label: 'Etapy procesow', table: 'process_stages', note: 'po splaszczeniu drzewa' },
  { label: 'Obietnice', table: 'promises', note: 'tresc redakcyjna — Sprint 4, etap 2' },
